...
echo HELIUS_REBATE_WALLET=$HELIUS_REBATE_WALLET >> .env
echo HELIUS_REBATE_BPS=$HELIUS_REBATE_BPS >> .env
echo HELIUS_BACKRUN_TRADES=$HELIUS_BACKRUN_TRADES >> .env
echo JUPITER_FEE_ACCOUNT=$JUPITER_FEE_ACCOUNT >> .env
echo JUPITER_FEE_BPS=$JUPITER_FEE_BPS >> .env
