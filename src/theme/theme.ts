...
export const lightThemeColors = {
  ...
  secondary: palette.graphiteGrey,
  primaryBackground: palette.deepPurple,
  secondaryBackground: palette.duskPurple,
  primaryText: palette.graphiteGrey,
  primaryIcon: palette.graphiteGrey,
  secondaryIcon: palette.steelGrey,
  secondaryText: palette.steelGrey,
  error: palette.red500,
  surface: palette.duskPurple,
  surfaceText: palette.graphiteGrey,
  surfaceSecondary: palette.deepPurple,
  surfaceSecondaryText: palette.steelGrey,
  surfaceContrast: palette.amethyst,
  surfaceContrastText: palette.white,
  plainInputBackground: palette.duskPurple,
  regularInputBackground: palette.deepPurple,
  highlight: palette.auroraGreen,
  testnet: palette.red500,
  transparent: palette.transparent,
  border: palette.glowYellow,
  priceUp: palette.red500,
  priceDown: palette.auroraGreen,
}
